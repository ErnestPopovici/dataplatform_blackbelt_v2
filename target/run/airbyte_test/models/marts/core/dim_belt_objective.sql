  ...
  create  table
    "prod"."dbt_pfarey"."dim_belt_objective__dbt_tmp"
...
FROM "prod"."dbt_pfarey"."stg_objective" AS objectives
left join "prod"."dbt_pfarey"."stg_belt_objective" AS belt_objective
    ON objectives.belt_objective_id = belt_objective.id
left join "prod"."dbt_pfarey"."stg_user_belt" AS user_belt
    ON user_belt.user_belt_id = objectives.user_belt_id
left join "prod"."dbt_pfarey"."stg_discipline" AS discipline
    ON user_belt.discipline_id = discipline.discipline_id
left join "prod"."dbt_pfarey"."stg_category" AS category
